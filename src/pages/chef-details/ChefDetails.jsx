			...
			<div className='my-container flex justify-center items-center gap-10'>
				<div className='max-w-lg text-white'>
					...
					<p className='max-w-lg my-5'>
						...
						culpa sint eveniet quaerat velit odio sit quia impedit praesentium.
						Exercitationem ipsa fugit porro culpa aliquam velit quas
						praesentium, dolorem sequi quo accusamus. Eaque enim qui error odio
						fuga, perferendis quos.
					</p>
